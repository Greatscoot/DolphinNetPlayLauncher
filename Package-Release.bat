...
REM GitHub/README showcase media. Keep GIF + MP4 pairs together so the README
REM can display inline animation while linking to the higher-quality video.
for %%M in (
  ...
  "dolphin-netplay-library-list.gif"
  "dolphin-netplay-library-list.mp4"
...
REM Runtime theme logos. Copy only the approved seven known assets.
for %%I in (
...
) do call :require "%%~I" || goto :missing
